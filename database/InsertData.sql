...
(1, 'marioRossi', 'password123', 'utente'),
(2, 'annaBianchi', 'securepass', 'utente'),
(3, 'lucaVerdi', 'mypassword', 'utente'),
(4, 'saraNeri', 'sara123', 'utente'),
(5, 'giovanniBlu', 'bluPass', 'utente'),
(6, 'elenaV', 'elenapass', 'utente'),
(7, 'alessioG', 'giordano45', 'utente'),
(8, 'francescaP', 'franci1987', 'utente'),
(9, 'matteoT', 'tommypass', 'utente'),
(10, 'giuliaS', 'giuliaPass', 'utente'),
(11, 'riccardoM', 'rickPass', 'utente'),
(12, 'valentinaD', 'vale123', 'utente'),
(13, 'emanueleF', 'ema2025', 'utente'),
(14, 'fede', 'fede', 'admin'),
(15, 'gloria', 'gloria', 'admin'),
(16, 'diane', 'diane', 'admin'),
(17, 'a', 'a', 'utente');
